...
describe('Transaction Entity', () => {
    it('should create a valid Transaction instance', () => {
        ...
        expect(transaction.getSale().productCode).toBe('100');
        expect(transaction.getRefund().isReversal).toBe(true);
    });
    ...
    it('should update sale correctly', () => {
        ...
        expect(transaction.getSale().productCode).toBe('200');
    });
    ...
    it('should update refund correctly', () => {
        ...
        expect(transaction.getRefund().productCode).toBe('200');
    });
});
